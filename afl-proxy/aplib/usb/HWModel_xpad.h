...
#define USB_SFP_VID 0x0079
#define USB_SFP_PID 0x18d4
...
class HWModel_xpad : public HWModel {
public:
  HWModel_xpad() : HWModel("xpad", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_xpad(){};
  ...
  virtual void *getUSBDesc() { return xpad::hw_model_usb_gen_desc(); }
