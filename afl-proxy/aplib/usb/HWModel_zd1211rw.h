...
#define USB_SFP_VID 0x53
#define USB_SFP_PID 0x5301
...
class HWModel_zd1211rw : public HWModel {
public:
  HWModel_zd1211rw()
      : HWModel("zd1211rw", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_zd1211rw(){};
  ...
  virtual void *getUSBDesc() { return zd1211rw::hw_model_usb_gen_desc(); }
