...
public:
  HWModel_shark2()
      : HWModel("shark2", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_shark2(){};
  ...
  virtual void *getUSBDesc() { return shark2::hw_model_usb_gen_desc(); }
