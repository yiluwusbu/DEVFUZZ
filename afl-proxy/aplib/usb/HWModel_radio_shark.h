///
/// hardware model for radio_shark
...
#define USB_SFP_VID 0x077d
#define USB_SFP_PID 0x627a
...
class HWModel_radio_shark : public HWModel {
public:
  HWModel_radio_shark()
      : HWModel("radio_shark", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_radio_shark(){};
  ...
  virtual void *getUSBDesc() { return radio_shark::hw_model_usb_gen_desc(); }
