...
#define USB_SFP_VID 0x086a
#define USB_SFP_PID 0x0100
...
class HWModel_emi26 : public HWModel {
public:
  HWModel_emi26() : HWModel("emi26", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_emi26(){};
  ...
  virtual void *getUSBDesc() { return emi26::hw_model_usb_gen_desc(); }
