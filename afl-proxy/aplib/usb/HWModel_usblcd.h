...
class HWModel_usblcd : public HWModel {
public:
  HWModel_usblcd()
      : HWModel("usblcd", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_usblcd(){};
  ...
  virtual void *getUSBDesc() { return usblcd::hw_model_usb_gen_desc(); }
