...
#define USB_SFP_VID 0x04e8
#define USB_SFP_PID 0x6601
...
class HWModel_visor : public HWModel {
public:
  HWModel_visor() : HWModel("visor", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_visor(){};
  ...
  virtual void *getUSBDesc() { return visor::hw_model_usb_gen_desc(); }
