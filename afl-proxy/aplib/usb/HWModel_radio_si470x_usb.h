///
/// hardware model for radio_si470x_usb
...
#define USB_SFP_VID 0x12cf
#define USB_SFP_PID 0x7111
...
class HWModel_radio_si470x_usb : public HWModel {
public:
  HWModel_radio_si470x_usb()
      : HWModel("radio_si470x_usb", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_radio_si470x_usb(){};
  ...
  virtual void *getUSBDesc() {
    return radio_si470x_usb::hw_model_usb_gen_desc();
  }
