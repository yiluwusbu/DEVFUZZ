///
/// hardware model for xbox_remote
...
#define USB_SFP_VID 0x040b
#define USB_SFP_PID 0x6521
...
class HWModel_xbox_remote : public HWModel {
public:
  HWModel_xbox_remote()
      : HWModel("xbox_remote", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_xbox_remote(){};
  ...
  virtual void *getUSBDesc() { return xbox_remote::hw_model_usb_gen_desc(); }
