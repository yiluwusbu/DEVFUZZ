...
class HWModel_usb8xxx : public HWModel {
public:
  HWModel_usb8xxx()
      : HWModel("usb8xxx", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_usb8xxx(){};
  ...
  virtual void *getUSBDesc() { return usb8xxx::hw_model_usb_gen_desc(); }
