...
class HWModel_mcba_usb : public HWModel {
public:
  HWModel_mcba_usb()
      : HWModel("mcba_usb", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_mcba_usb(){};
  ...
  virtual void *getUSBDesc() { return mcba_usb::hw_model_usb_gen_desc(); }
