///
/// hardware model for libertas_tf_usb
...
class HWModel_libertas_tf_usb : public HWModel {
public:
  HWModel_libertas_tf_usb()
      : HWModel("libertas_tf_usb", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_libertas_tf_usb(){};
  ...
  virtual void *getUSBDesc() {
    return libertas_tf_usb::hw_model_usb_gen_desc();
  }
