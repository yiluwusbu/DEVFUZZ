...
#define USB_SFP_VID 0x50d
#define USB_SFP_PID 0x6051
...
class HWModel_zd1201 : public HWModel {
public:
  HWModel_zd1201()
      : HWModel("zd1201", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_zd1201(){};
  ...
  virtual void *getUSBDesc() { return zd1201::hw_model_usb_gen_desc(); }
