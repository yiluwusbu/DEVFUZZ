...
class HWModel_mceusb : public HWModel {
public:
  HWModel_mceusb()
      : HWModel("mceusb", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_mceusb(){};
  ...
  virtual void *getUSBDesc() { return mceusb::hw_model_usb_gen_desc(); }
