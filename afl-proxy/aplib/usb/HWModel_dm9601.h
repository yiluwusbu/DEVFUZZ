...
#define USB_SFP_VID 0x0586
#define USB_SFP_PID 0x3427
...
public:
  HWModel_dm9601()
      : HWModel("dm9601", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_dm9601(){};
  ...
  virtual void *getUSBDesc() { return dm9601::hw_model_usb_gen_desc(); }
