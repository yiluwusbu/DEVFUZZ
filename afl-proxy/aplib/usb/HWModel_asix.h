...
class HWModel_asix : public HWModel {
public:
  HWModel_asix() : HWModel("asix", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_asix(){};
  ...
  virtual void *getUSBDesc() { return asix::hw_model_usb_gen_desc(); }
