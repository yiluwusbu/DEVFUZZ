...
#define USB_SFP_VID 0x0959
#define USB_SFP_PID 0x2bd0
...
class HWModel_hfcusb : public HWModel {
public:
  HWModel_hfcusb()
      : HWModel("hfcusb", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_hfcusb(){};
  ...
  virtual void *getUSBDesc() { return hfcusb::hw_model_usb_gen_desc(); }
