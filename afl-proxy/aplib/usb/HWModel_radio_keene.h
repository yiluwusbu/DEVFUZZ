///
/// hardware model for radio_keene
...
#define USB_SFP_VID 0x046d
#define USB_SFP_PID 0x0a0e
...
public:
  HWModel_radio_keene()
      : HWModel("radio_keene", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_radio_keene(){};
  ...
  virtual void *getUSBDesc() { return radio_keene::hw_model_usb_gen_desc(); }
