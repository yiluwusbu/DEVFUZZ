...
#define USB_SFP_VID 0x20b7
#define USB_SFP_PID 0x1540
...
class HWModel_atusb : public HWModel {
public:
  HWModel_atusb() : HWModel("atusb", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_atusb(){};
  ...
  virtual void *getUSBDesc() { return atusb::hw_model_usb_gen_desc(); }
