...
#define USB_SFP_VID 0x1934
#define USB_SFP_PID 0x0706
...
class HWModel_f81232 : public HWModel {
public:
  HWModel_f81232()
      : HWModel("f81232", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_f81232(){};
  ...
  virtual void *getUSBDesc() { return f81232::hw_model_usb_gen_desc(); }
