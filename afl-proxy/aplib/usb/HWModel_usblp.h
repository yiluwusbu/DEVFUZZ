...
#define USB_SFP_VID 0x04b8
#define USB_SFP_PID 0x0202
...
class HWModel_usblp : public HWModel {
public:
  HWModel_usblp() : HWModel("usblp", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_usblp(){};
  ...
  virtual void *getUSBDesc() { return usblp::hw_model_usb_gen_desc(); }
