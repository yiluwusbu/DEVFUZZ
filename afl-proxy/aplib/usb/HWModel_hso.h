...
#define USB_SFP_VID 0xaf0
#define USB_SFP_PID 0x6711
...
class HWModel_hso : public HWModel {
public:
  HWModel_hso() : HWModel("hso", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_hso(){};
  ...
  virtual void *getUSBDesc() { return hso::hw_model_usb_gen_desc(); }
