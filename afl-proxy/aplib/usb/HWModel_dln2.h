...
static void *hw_model_usb_gen_desc_dln2() { return &desc; }
}; // namespace dln2
class HWModel_dln2 : public HWModel {
public:
  HWModel_dln2() : HWModel("dln2", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_dln2(){};
  ...
  virtual void *getUSBDesc() { return dln2::hw_model_usb_gen_desc_dln2(); }
