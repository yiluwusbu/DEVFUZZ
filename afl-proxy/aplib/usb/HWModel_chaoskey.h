...
class HWModel_chaoskey : public HWModel {
public:
  HWModel_chaoskey()
      : HWModel("chaoskey", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_chaoskey(){};
  ...
  virtual void *getUSBDesc() { return chaoskey::hw_model_usb_gen_desc(); }
