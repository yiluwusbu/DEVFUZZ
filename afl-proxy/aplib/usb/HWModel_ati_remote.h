...
public:
  HWModel_ati_remote()
      : HWModel("ati_remote", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_ati_remote(){};
  ...
  virtual void *getUSBDesc() { return ati_remote::hw_model_usb_gen_desc(); }
