...
class HWModel_p54usb : public HWModel {
public:
  HWModel_p54usb()
      : HWModel("p54usb", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_p54usb(){};
  ...
  virtual void *getUSBDesc() { return p54usb::hw_model_usb_gen_desc(); }
