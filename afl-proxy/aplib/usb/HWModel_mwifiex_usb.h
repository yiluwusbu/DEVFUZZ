///
/// hardware model for mwifiex_usb
...
#define USB_SFP_VID 0x03ee
#define USB_SFP_PID 0x2501
...
class HWModel_mwifiex_usb : public HWModel {
public:
  HWModel_mwifiex_usb()
      : HWModel("mwifiex_usb", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_mwifiex_usb(){};
  ...
  virtual void *getUSBDesc() { return mwifiex_usb::hw_model_usb_gen_desc(); }
