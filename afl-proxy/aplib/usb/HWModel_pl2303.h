...
#define USB_SFP_VID 0x0caa
#define USB_SFP_PID 0x3001
...
class HWModel_pl2303 : public HWModel {
public:
  HWModel_pl2303()
      : HWModel("pl2303", USB_SFP_VID, USB_SFP_PID), probe_len(0) {}
  virtual ~HWModel_pl2303(){};
  ...
  virtual void *getUSBDesc() { return pl2303::hw_model_usb_gen_desc(); }
