///
/// hardware model for snd_intel8x0
...
class HWModel_snd_intel8x0 : public HWModel {
public:
  HWModel_snd_intel8x0()
      : HWModel("snd_intel8x0", 0x1022, 0x7445, 0, 0, 0x040100), probe_len(0) {
