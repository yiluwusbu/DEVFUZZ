...
class HWModel_8139cp : public HWModel {
public:
  HWModel_8139cp() : HWModel("8139cp", 0x10ec, 0x8139, 0, 0, 0x020000,  0x20), probe_len(0) {
...
Stage2HWModel * new_stage2_model_8139cp() {
  ...
  {0 , HWInput(0, 4,
          {0x40000, 0x100000, 0x200000, 0x280000, 0x400000, 0x500000, 0x2000000, 0x2800000, 0x8000000, 0x10000000, 0x30000000, 0x80000000, },
          {},
          {})
  },
  }),
  ...
  model->setSecondaryDMAInfo(16, 2112, 8, 4096);
  model->setDMAReg(0xe4, 0x840);
  model->setDMAReg(0x20, 0x840);
  return model;
}
