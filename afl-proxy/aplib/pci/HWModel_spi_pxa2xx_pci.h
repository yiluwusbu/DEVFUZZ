///
/// hardware model for spi_pxa2xx_pci
...
class HWModel_spi_pxa2xx_pci : public HWModel {
public:
  HWModel_spi_pxa2xx_pci()
      : HWModel("spi_pxa2xx_pci", 0x8086, 0x9ce6), probe_len(0) {
    setupBar({{PCI_BAR_TYPE_MMIO, 64 * 1024 * 1024},
              {PCI_BAR_TYPE_MMIO, 64 * 1024 * 1024},
              {PCI_BAR_TYPE_MMIO, 64 * 1024 * 1024}});
  }
  virtual ~HWModel_spi_pxa2xx_pci(){};
