...
pluginsConfig.Vmi = {
    baseDirs = {
        ...
        "<ENV_DIR>/s2e/images/debian-11.0.0-x86_64/guestfs"
...
--
-- The "s2e run fuzz" command sets up such a server in order to display
...
pluginsConfig.PeX = {
  logLevel = "debug",
  delayEnableSymbHW=0,
-- need to start afl proxy first!!!
  withAFL=false,
  irq_inject_per_x_ins=100000,
  printAllPortAccess=false,
  USECAPABILITY=false,
-- @ 58, -1 means no injection
  interrupt=-1,
  bar0type=0,
  bar0range=0xfff80000,
  bar1type=0,
  bar1range=0xfff80000,
  bar2type=0,
  bar2range=0xfff80000,
  bar3type=0,
  bar3range=0xfff80000,
  bar4type=0,
  bar4range=0xfff80000,
  bar5type=0,
  bar5range=0xfff80000,
-- KONAME
  VID=SFPVID,
  PID=SFPPID,
  SUBVID=SFPSUBVID,
